...
#  custom_commander_critical_strike, ##CC 1.324, disabled in Floris because it is bugged
  ...
  # add colored flame over troop to mark the team number
  (0.1, 0, 0, [],
    [
      (neq, "$g_mt_mode", abm_visit), # show whenever not visiting, i.e. only during contests
      (try_for_agents,":agent"),
        (agent_is_non_player, ":agent"), # don't show flame for player character
        ...
        (try_begin),
          (eq,":team",0),
          (particle_system_burst,"psys_team_0",pos1,9),
        (else_try),
          (eq,":team",1),
          (particle_system_burst,"psys_team_1",pos1,9),
        (else_try),
          (eq,":team",2),
          (particle_system_burst,"psys_team_2",pos1,9),
        (else_try),
          (eq,":team",3),
          (particle_system_burst,"psys_team_3",pos1,9),
        (else_try),
          (eq,":team",4),
          (particle_system_burst,"psys_team_4",pos1,9),
        (else_try),
          (eq,":team",5),
          (particle_system_burst,"psys_team_5",pos1,9),
        (else_try),
          (eq,":team",6),
          (particle_system_burst,"psys_team_6",pos1,9),
        (else_try),
          (eq,":team",7),
          (particle_system_burst,"psys_team_7",pos1,9),
        (try_end),
      (try_end),
    ]),
